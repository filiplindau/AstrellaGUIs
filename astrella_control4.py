...
class TestDeviceClient(TangoDeviceClient):
    ...
    def __init__(self):
        ...
        self.verdi_commands.addCmdButton("Init", self.verdi_init)
        ...
        self.verdi_commands2 = QTangoCommandSelection("Verdi", self.attr_sizes, self.colors)
        self.verdi_commands2.addCmdButton("Remote Enable", self.verdi_rem_enable)
        self.verdi_commands2.addCmdButton("Remote Disable", self.verdi_rem_disable)
        ...
        self.left_layout_0.addWidget(self.verdi_commands2)
        ...
        self.setGeometry(50, 20, 1100, 740)
    ...
    def verdi_status(self, data):
        ...
        self.verdi_commands2.setStatus(data, data.value)
