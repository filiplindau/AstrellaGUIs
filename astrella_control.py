...
class TestDeviceClient(TangoDeviceClient):
    ...
    def __init__(self):
        ...
        self.left_layout.addWidget(self.verdi_commands)
        ...
        self.right_layout.addWidget(self.vitara_commands)
        ...
        # Set up layout
        #
        self.add_layout(self.left_layout)
        ...
        self.left_layout.addWidget(self.verdi_commands)
        self.left_layout.addWidget(self.revolution_commands)
        self.left_layout.addWidget(self.sdg_commands)
        lay_verdi_sliders = QtWidgets.QHBoxLayout()
        lay_verdi_sliders.addWidget(self.verdi_power_slider)
        lay_verdi_sliders.addWidget(self.verdi_current_slider)
        lay_verdi_sliders.addWidget(self.verdi_temperature_slider)
        h_spacer_1 = QtWidgets.QSpacerItem(10, 10, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        # lay_verdi_sliders.addSpacerItem(h_spacer_1)
        self.left_layout.addLayout(lay_verdi_sliders)
        lay_rev_sliders = QtWidgets.QHBoxLayout()
        lay_rev_sliders.addWidget(self.revolution_power_slider)
        lay_rev_sliders.addWidget(self.revolution_current_slider)
        lay_rev_sliders.addWidget(self.revolution_temp_slider)
        ...
        self.left_layout.addSpacerItem(v_spacer_1)

        self.right_layout.addWidget(self.vitara_commands)
        self.right_layout.addWidget(self.vitara_rasterizing_label)
        self.right_layout.addWidget(self.vitara_modelock_label)
        self.right_layout.addWidget(self.slap_commands)
        lay_vitara_sliders = QtWidgets.QHBoxLayout()
        lay_vitara_sliders.addWidget(self.vitara_power_slider)
        lay_vitara_sliders.addWidget(self.vitara_l0_slider)
        lay_vitara_sliders.addWidget(self.vitara_dl_slider)
        ...
        self.right_layout.addSpacerItem(v_spacer_2)
    ...
    def slap_status(self, data):
        self.slap_commands.setStatus(data)
